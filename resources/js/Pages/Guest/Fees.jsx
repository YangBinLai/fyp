            ...
            <div className="bg-gray-100 py-12">
                <div className="container mx-auto px-6 md:px-12 lg:px-24">
                    ...
                    <div className="text-center mt-12">
                        ...
                        <a href={auth.user ? route('register_class') : route('login')} className="bg-blue-800 text-white px-8 py-3 rounded-md text-lg font-semibold hover:bg-blue-700 transition">
                            Register Class Now !
                        </a>
                    </div>
                </div>
